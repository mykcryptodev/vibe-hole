...
/**
 * Represents the parameters for the "fidVibes" function.
 */
export type FidVibesParams = {
...
/**
 * Calls the "fidVibes" function on the contract.
 * @param options - The options for the fidVibes function.
 * @returns The parsed result of the function call.
 * @example
 * ```
 * import { fidVibes } from "TODO";
 *
 * const result = await fidVibes({
 *  arg_0: ...,
 *  arg_1: ...,
 * });
 *
 * ```
 */
export async function fidVibes(
  options: BaseTransactionOptions<FidVibesParams>
) {
  return readContract({
    contract: options.contract,
    method: [
...
/**
 * Represents the parameters for the "getFidVibes" function.
 */
export type GetFidVibesParams = {
  fid: AbiParameterToPrimitiveType<{"internalType":"uint256","name":"fid","type":"uint256"}>
...
/**
 * Calls the "getFidVibes" function on the contract.
 * @param options - The options for the getFidVibes function.
 * @returns The parsed result of the function call.
 * @example
 * ```
 * import { getFidVibes } from "TODO";
 *
 * const result = await getFidVibes({
 *  fid: ...,
 *  offset: ...,
 *  limit: ...,
 * });
 ...
 * ```
 */
export async function getFidVibes(
  options: BaseTransactionOptions<GetFidVibesParams>
) {
  return readContract({
    contract: options.contract,
    method: [
  ...
  [
    ...
    params: [options.fid, options.offset, options.limit]
  });
};
...
/**
 * Calls the "getUnmatchedVibeIds" function on the contract.
 * @param options - The options for the getUnmatchedVibeIds function.
 * @returns The parsed result of the function call.
 * @example
 * ```
 * import { getUnmatchedVibeIds } from "TODO";
 *
 * const result = await getUnmatchedVibeIds();
 *
 * ```
 */
export async function getUnmatchedVibeIds(
  options: BaseTransactionOptions
) {
  return readContract({
    contract: options.contract,
